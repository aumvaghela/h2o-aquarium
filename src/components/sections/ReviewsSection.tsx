    ...
    <section className="py-10 lg:py-12 bg-background relative overflow-hidden" id="reviews">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-end mb-10 lg:mb-8 gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:flex-nowrap gap-2 sm:gap-4 bg-white rounded-2xl sm:rounded-full px-4 sm:px-6 py-3 elementor-shadow w-full sm:w-auto justify-center">
            ...
            <a href="https://g.page/r/CUAcv486Wl3NEBM/review" target="_blank" rel="noopener noreferrer" className="text-accent-dark hover:text-accent-green text-sm sm:text-base font-bold tracking-tight transition-colors">Review us on Google</a>
          </div>
        </div>
      </div>
